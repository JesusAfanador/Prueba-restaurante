...
import { Background, Box, ContPrincipal, P, P2, InputContainer, Label, Input, Boton, Table, Thead, Tbody, Tr1, Tr2, Th, Td, TdMesa } from "./styled";
...
const RegistroFactura = () => {
    ...
    return (
        <Background>
            <Box style={{display:"flex", flexDirection:"column", width:"300px"}}>
                <InputContainer>
                    <Label>Mesa:</Label>
                    <Input autoComplete="off" type="text" name="mesa" value={filtros.mesa || ""} onChange={handleFiltroChange} />
                </InputContainer>
                <InputContainer>
                    <Label>Fecha:</Label>
